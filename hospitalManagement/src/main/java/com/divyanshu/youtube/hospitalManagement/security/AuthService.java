...
import com.divyanshu.youtube.hospitalManagement.dto.LoginRequestDto;
import com.divyanshu.youtube.hospitalManagement.dto.LoginResponseDto;
import com.divyanshu.youtube.hospitalManagement.dto.SignupResponseDto;
...
public class AuthService<User, SignUpRequestDto> {
    ...
    public LoginResponseDto login(LoginRequestDto loginRequestDto) {
        ...
        String token = authUtil.generateAccessToken((com.divyanshu.youtube.hospitalManagement.entity.User) user);
    ...
    public ResponseEntity<LoginResponseDto> handleOAuth2LoginRequest(OAuth2User oAuth2User, String registrationId) {
        ...
        LoginResponseDto loginResponseDto = new LoginResponseDto(authUtil.generateAccessToken((com.divyanshu.youtube.hospitalManagement.entity.User) user), user.getId());
